...
* Paste the url indicated by the output of the previous command  into a web browser to access the application (probably something like [link](http://localhost:3000)
